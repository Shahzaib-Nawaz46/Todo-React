...
const element = props => {
  return (
    <div className='flex flex-col align-center items-center  p-7  w-full font-sans  '>
        <div className='border w-1/2 p-5 rounded-lg shadow-lg text-center min-h'>
        ...
        <input className ='w-[80%] border rounded-2xl p-1.5' type="text" placeholder='Enter your todos' />
        <button className='bg-purple-800 p-2 px-6 mx-2 rounded-3xl text-white font-semibold'>Save</button>
